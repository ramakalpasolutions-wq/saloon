    ...
    <AdminLayout requiredRole="salon-admin">
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Review and approve customer booking requests</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {bookings.map((booking) => (
              <div key={booking._id} className="bg-white rounded-lg shadow-sm p-6 border-2 border-yellow-200">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 mb-4">
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          ...
                          <p className="text-gray-900 text-lg">📞 {booking.customerPhone}</p>
                        </div>
                        <div>
                    ...
                    <div className="mb-4">
                      <span className="font-semibold text-gray-900 block mb-2">Selected Services:</span>
                      <div className="space-y-2">
                        {booking.services?.map((service, index) => (
                          <div key={index} className="flex items-center justify-between bg-green-50 p-3 rounded-lg">
                            ...
                            <span className="font-semibold text-green-700">₹{service.price}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500">
                      <span>⏱️ Estimated: {booking.estimatedWaitTime} minutes</span>
