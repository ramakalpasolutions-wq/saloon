      ...
      <div className="max-w-4xl">
        <div className="mb-6">
          <Link href="/admin/salons">
            <button className="text-green-600 hover:text-green-700 mb-4">
              ← Back to All Salons
            </button>
          </Link>
          <h1 className="text-3xl font-bold text-gray-900">Bulk Upload Salons</h1>
          <p className="text-gray-600 mt-2">Upload an Excel file with Google Maps links to create salons</p>
        </div>

        {/* Instructions */}
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          <h2 className="text-lg font-semibold text-blue-900 mb-3">📋 How to Get Google Maps Link</h2>
          ...
          <div className="mt-4 p-4 bg-white rounded-lg border border-blue-300">
            <p className="text-sm font-semibold text-blue-900 mb-2">✅ Supported Google Maps Link Formats:</p>
        ...
        {/* File Upload */}
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Step 2: Upload Excel File</h2>
        ...
        {results && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            {results.created.length > 0 && (
              <div className="mb-6">
                <h3 className="font-semibold text-green-900 mb-3">✅ Successfully Created with Map Locations:</h3>
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {results.created.map((item, index) => (
                    <div key={index} className="bg-green-50 border border-green-200 rounded-lg p-3">
                      <p className="font-medium text-green-900">{item.salonName}</p>
                      <p className="text-sm text-green-700">Admin: {item.adminEmail}</p>
