        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          <div className="flex gap-2 flex-wrap">
            {['all', 'main-admin', 'salon-admin', 'customer', 'staff'].map((role) => (
              ...
              >
                {role === 'all' ? 'All Users' : getRoleLabel(role)} ({getRoleCount(role)})
              </button>
            ))}
          </div>
        </div>
          ...
          <div>
            <div className="mb-4 flex items-center justify-between">
              <div className="text-sm text-gray-600">
                ...
                {roleFilter !== 'all' && <span className="font-medium"> • Filtered by: {getRoleLabel(roleFilter)}</span>}
              </div>
              {(searchQuery || roleFilter !== 'all') && (
                <button
                  onClick={() => {
                        ...
                        <td className="px-6 py-4">
                          ...
                          <div className="flex flex-col gap-2 min-w-[120px]">
                            <button
                              ...
                              className="w-full px-3 py-1.5 bg-blue-600 text-white rounded hover:bg-blue-700 text-xs font-medium transition-colors"
                            >
                              Edit
                            </button>
                            <button
                            ...
                            <button
                              ...
                              className="w-full px-3 py-1.5 bg-red-600 text-white rounded hover:bg-red-700 text-xs font-medium transition-colors"
                            >
                              Delete
                            </button>
                          </div>
